...
use Boot\Foundation\Console\CastMakeCommand;
use Boot\Foundation\Console\ChannelMakeCommand;
use Boot\Foundation\Console\ClearCompiledCommand;
use Boot\Foundation\Console\ComponentMakeCommand;
use Boot\Foundation\Console\ConfigCacheCommand;
use Boot\Foundation\Console\ConfigClearCommand;
use Boot\Foundation\Console\ConsoleMakeCommand;
use Boot\Foundation\Console\DownCommand;
use Boot\Foundation\Console\EnvironmentCommand;
use Boot\Foundation\Console\EventCacheCommand;
use Boot\Foundation\Console\EventClearCommand;
use Boot\Foundation\Console\EventGenerateCommand;
use Boot\Foundation\Console\EventListCommand;
use Boot\Foundation\Console\EventMakeCommand;
use Boot\Foundation\Console\ExceptionMakeCommand;
use Boot\Foundation\Console\JobMakeCommand;
use Boot\Foundation\Console\KeyGenerateCommand;
use Boot\Foundation\Console\ListenerMakeCommand;
use Boot\Foundation\Console\MailMakeCommand;
use Boot\Foundation\Console\ModelMakeCommand;
use Boot\Foundation\Console\NotificationMakeCommand;
use Boot\Foundation\Console\ObserverMakeCommand;
use Boot\Foundation\Console\OptimizeClearCommand;
use Boot\Foundation\Console\OptimizeCommand;
use Boot\Foundation\Console\PackageDiscoverCommand;
use Boot\Foundation\Console\PolicyMakeCommand;
use Boot\Foundation\Console\ProviderMakeCommand;
use Boot\Foundation\Console\RequestMakeCommand;
use Boot\Foundation\Console\ResourceMakeCommand;
use Boot\Foundation\Console\RouteCacheCommand;
use Boot\Foundation\Console\RouteClearCommand;
use Boot\Foundation\Console\RouteListCommand;
use Boot\Foundation\Console\RuleMakeCommand;
use Boot\Foundation\Console\ServeCommand;
use Boot\Foundation\Console\StorageLinkCommand;
use Boot\Foundation\Console\StubPublishCommand;
use Boot\Foundation\Console\TestMakeCommand;
use Boot\Foundation\Console\UpCommand;
use Boot\Foundation\Console\VendorPublishCommand;
use Boot\Foundation\Console\ViewCacheCommand;
use Boot\Foundation\Console\ViewClearCommand;
