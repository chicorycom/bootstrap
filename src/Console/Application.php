...
use Closure;
use Boot\Console\Events\ArtisanStarting;
use Boot\Console\Events\CommandFinished;
use Boot\Console\Events\CommandStarting;
...
class Application extends SymfonyApplication implements ApplicationContract
{
    ...
    {
        parent::__construct('Chicorycom Framework', $version);
